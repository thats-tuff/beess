...
window.playerGear={
    ...
    boots:{
        ...
        coconutClogs:{
            ...
            applyStats:function(stats,player){
                ...
                stats.pollenFromCoconuts*=10
                stats.redPollen*=10
                stats.whitePollen*=10
                stats.bluePollen*=10
                stats.honeyFromTokens*=10
                stats.beeAttack*=100
        ...
        mondoBoots:{
            ...
            applyStats:function(stats,player){
                ...
                stats.movementCollection+=1000000000
                stats.walkSpeed*=5
                stats.jumpPower*=3
                stats.pollenFromBees*=10
                stats.beeSpeed*=1.24
            },
    ...
    leftGuard:{
        ...
        redGuard:{
            ...
            cost:['10 honey','30 strawberry','1 royalJelly','1 stinger'],
        },
